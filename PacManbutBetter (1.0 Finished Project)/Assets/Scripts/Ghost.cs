...
public class Ghost : MonoBehaviour
{
    ...
    [SerializeField] private GameObject classicGhost,betterGhost;
    ...
    private void Start()
    {
        ...
        {
            classicGhost.SetActive(true);
            betterGhost.SetActive(false);
        }
        else
        {
            classicGhost.SetActive(false);
            betterGhost.SetActive(true);
        }
    }
